		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#kymauserinfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kymauserinfo-display": {
								"semanticObject": "kymauserinfo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kymauserinfo",
									"url": sap.ui.require.toUrl("kymauserinfo")
								}
							}
						}
					}
